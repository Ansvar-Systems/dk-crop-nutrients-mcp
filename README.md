# Denmark Crop Nutrients MCP

[![CI](https://github.com/ansvar-systems/dk-crop-nutrients-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/ansvar-systems/dk-crop-nutrients-mcp/actions/workflows/ci.yml)
[![GHCR](https://github.com/ansvar-systems/dk-crop-nutrients-mcp/actions/workflows/ghcr-build.yml/badge.svg)](https://github.com/ansvar-systems/dk-crop-nutrients-mcp/actions/workflows/ghcr-build.yml)
...
```json
{
  "mcpServers": {
    "uk-crop-nutrients": {
      "command": "npx",
      "args": ["-y", "@ansvar/dk-crop-nutrients-mcp"]
    }
  }
}
```
...
```bash
claude mcp add uk-crop-nutrients npx @ansvar/dk-crop-nutrients-mcp
```

### Streamable HTTP (remote)

```
https://mcp.ansvar.eu/dk-crop-nutrients/mcp
```

### Docker (self-hosted)

```bash
docker run -p 3000:3000 ghcr.io/ansvar-systems/dk-crop-nutrients-mcp:latest
```

### npm (stdio)

```bash
npx @ansvar/dk-crop-nutrients-mcp
```
